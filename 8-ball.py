...
def function8ball(question):
    ...
    answer_printer = random.choice(answer)
...
bot = commands.Bot(command_prefix = '8b', description = '8ball bot', intents = intents)
...
@bot.command()
async def test(ctx, question: str):
    """description"""
    await ctx.send(function8ball(question))
